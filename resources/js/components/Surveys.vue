	...
	<PageComponent>
		<template v-slot:header>
			<div class="flex justify-between items-center">
		        ...
		        <router-link :to="{name:'SurveyCreate'}" class="px-2 py-2 flex justify-between text-white bg-emerald-500 rounded-md hover:bg-emerald-600">
				...
				<div class="flex justify-center mt-5">
					<nav
						...
						<a
							...
							aria-current="page"
							class="relative inline-flex items-center px-4 py-2 border text-sm font-medium white-space-nowrap"
							:class="[
								link.active 
